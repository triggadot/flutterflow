      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case ShipmentTrackingRow:
            return ShipmentTrackingRow(data);
          case AccountsPayableRow:
            return AccountsPayableRow(data);
          case ActivityHelpersRow:
            return ActivityHelpersRow(data);
          case TpHistoryRow:
            return TpHistoryRow(data);
          case MonthlySalesSummaryRow:
            return MonthlySalesSummaryRow(data);
          case ExpenseCategoriesRow:
            return ExpenseCategoriesRow(data);
          case CustomerPaymentsRow:
            return CustomerPaymentsRow(data);
          case FinancialReportsRow:
            return FinancialReportsRow(data);
          case EstimateLineItemsRow:
            return EstimateLineItemsRow(data);
          case TpShipmentsRow:
            return TpShipmentsRow(data);
          ...
          case CompanyTasksRow:
            return CompanyTasksRow(data);
          case EstimatesRow:
            return EstimatesRow(data);
          case BoxSizesRow:
            return BoxSizesRow(data);
          case CustomerSalesSummaryRow:
            return CustomerSalesSummaryRow(data);
          case ExpensesRow:
            return ExpensesRow(data);
          case UsersRow:
