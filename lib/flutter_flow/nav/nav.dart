...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          requireAuth: true,
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'main_users')
              : const MainUsersWidget(),
        ),
        FFRoute(
          name: 'main_recent',
          path: '/mainRecent',
        ...
        FFRoute(
          ...
          requireAuth: true,
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'LoginSignup')
              : const NavBarPage(
                  initialPage: 'LoginSignup',
                  page: LoginSignupWidget(),
                ),
        ),
        FFRoute(
          name: 'dashboard',
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/Asset_2Xan_Logo170.png',
                    fit: BoxFit.contain,
                  ),
                )
